  ...
  return (
    <>
      <div className="container relative">
        ...
        <div 
             data-aos="fade-right"
            className="absolute opacity-50 sm:opacity-100 top-5 left-16 sm:bottom-0 sm:left-0">
          <img src={leaf} alt="leaf" className="max-w-[160px]" />
        </div>
        <div 
            data-aos="fade-right"
            className="absolute opacity-50 bottom-16 left-16 sm:bottom-0 sm:left-0 sm:opacity-100">
          <img src={tomato} alt="tomato" className="max-w-[280px]" />
        </div>
        <div 
            data-aos="fade-left"
            className="absolute opacity-50 top-10 right-16 sm:right-20 sm:opacity-100">
        ...
        <div 
            data-aos="fade-right"
            className="absolute -translate-x-1/2 -translate-y-1/2 opacity-50 top-1/2 left-1/3 sm:opacity-100">
